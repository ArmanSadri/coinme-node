 ...
 */
var STATIC_BITCOIN_PER_SATOSHI = new _big2.default(0.00000001);

/**
 * @type {Big|BigJsLibrary.BigJS}
 */
var STATIC_SATOSHI_PER_BITCOIN = new _big2.default(100000000);
...
var Bitcoin = function (_Currency) {
  ...
  _createClass(Bitcoin, null, [{
    ...
    value: function fromSatoshi(valueInSatoshis) {
      return Bitcoin.fromBitcoin(_Currency3.default.toValueOrFail(valueInSatoshis).div(Bitcoin.SATOSHIS_PER_BITCOIN));
    }
